...
public class InputData {
    // No need to use two different approach to read from Console
    Scanner console = new Scanner(System.in);
    BufferedReader br = new BufferedReader(new InputStreamReader(System.in));

    // Function naming pattern is not common: for subject => getString, for agent name=> getAgentName.
    // I would rather implement a single method to read any kind of user input
    ...
    // Practice to use generics with Collections
    public List getTagsList() {
        ...
        // Redundant Variable tagList; assigned and immediately returned
